    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()){
            ...
            case MotionEvent.ACTION_MOVE:
                int distanceX = mLastXIntercept - x;
                int distanceY = mLastYIntercept - y;
                if (((distanceX < 0) && (mChildIndex == 0)) ||
                        ((distanceX > 0) && (mChildIndex == mChildNum - 1))){
                    return false;
                }
                ...
                Log.i("TAG", "onInterceptTouchEvent------" + isIntercept + distanceX + "----" + distanceY);
                break;
