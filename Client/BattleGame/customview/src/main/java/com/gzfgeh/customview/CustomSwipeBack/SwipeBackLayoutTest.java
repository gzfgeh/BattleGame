 ...
 */
public class SwipeBackLayoutTest extends LinearLayout {
    ...
    public SwipeBackLayoutTest(Context context) {
        this(context, null);
    }

    public SwipeBackLayoutTest(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeBackLayoutTest(Context context, AttributeSet attrs, int defStyleAttr) {
